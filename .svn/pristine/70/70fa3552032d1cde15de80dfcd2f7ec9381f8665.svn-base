...
;
function shielding_guiSaveUndoROI, pInfo, ACTION=action, OROI=oROI

	forward_function shielding_guiGenerateUndoRedoROI

	oUndoRedo = shielding_guiGenerateUndoRedoROI( $
			pInfo, ACTION=action, oROI=oROI )
	if obj_valid( oUndoRedo ) then begin
		(*pInfo).oUndoContainer->add, oUndoRedo
		widget_control, (*pInfo).wUndoROIButton, SENSITIVE=1

		; For debugging
		oUndoRedo->getProperty, TABLE_DATA=data
...
;
function shielding_guiSaveRedoROI, pInfo, ACTION=action, OROI=oROI
	...
	oUndoRedo = shielding_guiGenerateUndoRedoROI( $
			pInfo, ACTION=action, oROI=oROI )
	if obj_valid( oUndoRedo ) then begin
		(*pInfo).oRedoContainer->add, oUndoRedo
...
pro shielding_guiUndoROI, pInfo
	...
	oRedo = shielding_guiSaveRedoROI( pInfo, ACTION=action, oROI=oROI )
...
pro shielding_guiRedoROI, pInfo
	...
	oUndo = shielding_guiSaveUndoROI( pInfo, ACTION=action, oROI=oROI )
