...
pro shielding_guiUpdateImageInfo, $
	...
	dist = 'dist: [--,--]--m from [' + $
		   strtrim( string( originX, FORMAT='(f8.2)' ), 2 ) + ',' + $
		   strtrim( string( originY, FORMAT='(f8.2)' ), 2 ) + ']m'
	...
	if keyword_set( coord ) then begin
		...
		if bEventInImage then begin
			...
			dist = 'dist: [' + $
				   strtrim( string( x, FORMAT='(f8.2)' ), 2 ) + ',' + $
				   strtrim( string( y, FORMAT='(f8.2)' ), 2 ) + ']' + $
				   strtrim( string( dist, FORMAT='(f8.2)' ), 2 ) + 'm from [' + $
				   strtrim( string( originX, FORMAT='(f8.2)' ), 2 ) + ',' + $
				   strtrim( string( originY, FORMAT='(f8.2)' ), 2 ) + ']m'
		endif
				...
				if sEvent.press eq 1 then begin ; left button pressed
					...
					case (*pInfo).mode of
						...
						'source_roi': begin
								...
								shielding_guiAddSourceSpecs, pInfo, oROI, /PROMPT
								bOk = shielding_guiSetCurrentROI( pInfo, /NONE )
								shielding_guiUpdateROIButtons, pInfo
