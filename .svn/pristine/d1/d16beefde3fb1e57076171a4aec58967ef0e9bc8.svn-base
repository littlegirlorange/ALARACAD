...
function shielding_guiCalculateShieldedDose, $
    modality, $
    material, $
    d, $
    tracer, $
    ...
    if n_params() ne 6 then return, -1
    ...
    if modality eq 'PET' then begin
		...
		for iEnergy=0, nEnergies-1 do begin
			...
			doses[iEnergy] = 4.58939 * energy * frac * muEn * a0 * time / d^2
...
end ; of shielding_guiCalculateShieldedDose