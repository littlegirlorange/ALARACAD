...
pro shielding_guiCalculateQueryTable, $
	pInfo, $
	QPOINT=qPoint, $
	QNAME=qName
	...
	openw, uLun, 'C:\Users\makusan\Documents\Research\MC\RD52\' + qName + '_unshieldedDoses.txt', /GET_LUN
	openw, sLun, 'C:\Users\makusan\Documents\Research\MC\RD52\' + qName + '_shieldedDoses.txt', /GET_LUN
				...
				if nPRows gt 0 then begin
					...
					for iPRow=0, nPRows-1 do begin
						...
						if bQuery then begin
							...
							widget_control, (*pInfo).wQueryText, SET_VALUE=text, /APPEND
							uLine = pName + string(9b) + pTable[eP.desc,pRows[iPRow]]
							sLine = pName + string(9b) + pTable[eP.desc,pRows[iPRow]]
						endif ; bQuery
...
;								endif
						...
						if bQuery then begin
							...
							widget_control, (*pInfo).wQueryText, SET_VALUE=text, /APPEND
							; Unshielded dose
							printf, uLun, uLine + string(9b) + strtrim(total(doses)/1000.0,2)
							printf, sLun, sLine + string(9b) + strtrim(total(shieldedDoses)/1000.0,2)
						endif
