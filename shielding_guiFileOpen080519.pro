...
function shielding_guiOpenSession, pInfo
	...
	if err ne 0 then begin
		void = dialog_message( TITLE='Session not opened', !error_state.msg )
	...
	*(*pInfo).pSeries1 = series1
	...
	if sDims[0] ne 10 then begin
		...
		if sDims[0] lt 8 then begin
			...
			newSData[eS.h1,*] 			= make_array( sDims[1], VALUE='0.0' )
			if keyword_set( shieldHeight ) then begin
				...
				value = '3.81'
			endelse
			newSData[eS.h2,*]			= make_array( sDims[1], VALUE=value )
